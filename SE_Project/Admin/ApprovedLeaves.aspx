<%@ Page Title="" Language="C#" MasterPageFile="~/SiteAdmin.Master" AutoEventWireup="true" CodeBehind="ApprovedLeaves.aspx.cs" Inherits="SE_Project.Admin.ApprovedLeaves" %>
            ...
            <div class="card shadow">
                ...
                <div class="table-responsive table mt-2" aria-describedby="dataTable_info">
                    <table class="table dataTable my-0">
                        ...
                        <tbody>
                            <asp:GridView ID="GridView1" OnPageIndexChanging="OnPaging" runat="server" ShowHeaderWhenEmpty="true" OnRowDataBound="GridView1_RowDataBound" class="table dataTable my-0" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="emp_id" CellPadding="4" ForeColor="#333333" GridLines="Both">
