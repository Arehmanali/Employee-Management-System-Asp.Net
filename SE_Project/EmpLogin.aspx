<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmpLogin.aspx.cs" Inherits="SE_Project.EmpLogin" %>
                                ...
                                <div class="text-left align-content-center"><img class="rounded-circle d-lg-flex align-items-center justify-content-lg-center align-items-lg-center" src="assets/img/generaluser.png" style="margin-left: 180px;">
                                    ...
                                    <form class="user" runat="server">
                                        ...
                                        <div class="form-group" runat="server">
                                            <asp:TextBox ID="txtEmail" runat="server" class="form-control form-control-user fa fa-user" placeholder="username"></asp:TextBox>
                                        ...
                                        <div class="form-group" runat="server">
                                            <asp:TextBox ID="txtPassword" TextMode="Password" runat="server" class="form-control form-control-user fa fa-eye" placeholder="Password"></asp:TextBox>
                                    ...
                                    <div class="text-center"><a class="small" href="EmpPasswordForget.aspx">Forgot Password?</a></div>
