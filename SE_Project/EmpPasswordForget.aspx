<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmpPasswordForget.aspx.cs" Inherits="SE_Project.EmpPasswordForget" %>
                        ...
                        <div class="row" style="height: 400px;">
                            <div class="col-auto col-lg-6 offset-lg-3 align-self-center">
                                <div class="text-center text-primary border-primary">
                                    ...
                                    <div class="text-center"><a class="small" href="EmpLogin.aspx">Back to Login!</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
